...
/* package solvable-games-0.1.0.0 */
#define VERSION_solvable_games "0.1.0.0"
#define MIN_VERSION_solvable_games(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package arithmoi-0.4.3.0 */
#define VERSION_arithmoi "0.4.3.0"
...
#define CURRENT_COMPONENT_ID "solvable-games-0.1.0.0"

#define CURRENT_PACKAGE_KEY "solvable-games-0.1.0.0"
